...
sms_raw <- read.csv("C:/Users/wrwqr/OneDrive/Desktop/ADP/ML with R/Naive_Bayesian/sms_spam.csv", stringsAsFactors = FALSE)
...
#VCorpus : 텍스트 문서를 저장하기 위한 R 객체를 만듦
#
