...
credit <- read.csv("C:/Users/wrwqr/OneDrive/Desktop/ADP/ML with R/Decision Tree/credit.csv")
str(credit)
...
## Step 2: Exploring and preparing the data ---- 
mushrooms <- read.csv("C:/Users/wrwqr/OneDrive/Desktop/ADP/ML with R/Decision Tree/mushrooms.csv", stringsAsFactors = TRUE #stringAsFactors : 팩터변환 할건지 안할건지)

# examine the structure of the data frame
str(mushrooms)

# drop the veil_type feature
mushrooms$veil_type <- NULL #팩터가 한개 뿐임
