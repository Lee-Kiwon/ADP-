...
insurance <- read.csv("C:/Users/wrwqr/OneDrive/Desktop/ADP/ML with R/Regression/insurance.csv", stringsAsFactors = TRUE)
str(insurance)
...
#회귀모델 적합 전에는 독립변수와 종속변수가 얼마나 관계 있는지 살펴보기
...
#타원 : 상관관계 타원, 중앙점은 x,y축 변수의 평균값, 모양 늘어지면 상관관계 늘어남
#산포도 위 곡선은 뢰스 평활, xy축 관계 사이 일반적 관계
...
## Step 2: Exploring and preparing the data ----
wine <- read.csv("C:/Users/wrwqr/OneDrive/Desktop/ADP/ML with R/Regression/whitewines.csv")
